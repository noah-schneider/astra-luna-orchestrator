...
bundles to the native `astra_luna_builder` agent pinned to GPT-5.6 Luna at xhigh.
...
uses the native GPT-5.6 Luna model; obey the user's data-sharing and spending

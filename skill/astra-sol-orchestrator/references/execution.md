...
The default is one native Sol child in the current workspace for one coherent
...
Parallelism is opt-in per plan. Use at most two Sol writers by default, and only

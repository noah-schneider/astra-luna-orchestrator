...
def inspect(
    ...
    if config.get("model") in {WORKER_MODEL, f"openai/{WORKER_MODEL}"}:
        raise SetupError("The root model is GPT-5.6 Luna. Select Astra as root before installing this workflow.")

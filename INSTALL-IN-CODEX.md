...
```text
Install the Astra + GPT-6 Luna and Astra + GPT-6 Sol skills for Codex from this repository.

Pin gpt-6-luna at xhigh and gpt-6-sol at high in separate native roles. Do not infer or auto-select a
billing provider.
...
roles must pin gpt-6-luna at xhigh and gpt-6-sol at high.
...
I authorize installation of both personal skills, native astra_luna_builder and
astra_sol_builder roles,
...
The roles must pin GPT-6 Luna at xhigh and GPT-6 Sol at high, inherit sandbox/approvals and disable nested agents.
...
$astra-luna-orchestrator or $astra-sol-orchestrator. Actual model-selection verification belongs to the first

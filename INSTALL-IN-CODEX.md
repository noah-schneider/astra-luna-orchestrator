...
```text
Install Astra + GPT-5.6 Luna for Codex from this repository.

Use native worker model gpt-5.6-luna at xhigh. Do not infer or auto-select a
billing provider.
...
Preserve my current Astra root model and reasoning effort, config.toml,
...
role must pin gpt-5.6-luna at xhigh.
...
The role must pin GPT-5.6 Luna at xhigh, inherit sandbox/approvals and disable nested agents.
...
$astra-luna-orchestrator. Actual model-selection verification belongs to the first
